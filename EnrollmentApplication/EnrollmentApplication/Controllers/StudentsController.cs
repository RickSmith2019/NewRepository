...
namespace EnrollmentApplication.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,LastName,FirstName,Address1,Address2,City,Zipcode,State")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,LastName,FirstName,Address1,Address2,City,Zipcode,State")] Student student)
        {
            if (ModelState.IsValid)
            {
